...
<html>
    ...
    <body class="a">
        <div class="main">
            ...
            <div class="a">
                <br>
                <form class="myForm" method="post" enctype="application/x-www-form-urlencoded" action="View_Prescription_Servlet">
                    ...
                    <button style="margin-top: 0px">View Prescriptions</button>
                </form>


                <form class="myForm" method="post" enctype="application/x-www-form-urlencoded" action="ViewPatAccServlet">
                    <input type="hidden" name="user_id" value="<%=request.getAttribute("user_id")%>">
                    <input type="hidden" name="user_pass" value="<%=request.getAttribute("user_pass")%>">

                    <button style="margin-top: 0px">View My Account</button>
                </form>
                <form class="myForm" name="pat_acc" method="post" enctype="application/x-www-form-urlencoded" action="resetPassword.jsp">
                    <input type="hidden" name="user_id" value="<%=request.getAttribute("user_id")%>">
                    <input type="hidden" name="form_name" value="patient">
