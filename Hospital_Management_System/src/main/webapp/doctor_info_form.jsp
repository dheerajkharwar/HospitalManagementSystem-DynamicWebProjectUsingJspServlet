<%-- 
    Document   : doctor_info_form
    Created on : Dec 12, 2022, 11:15:08 AM
    Author     : user
--%>
    ...
    <body class="a">                            
        <div class="main">
            ...
            <div class="a">
                ...
                <form class="myForm" method="post" enctype="application/x-www-form-urlencoded" action="Doctor_Info_Servlet" onsubmit="return doctorNurseInfoValidation()">
                    <br>
                    ...
                    <table id = "table">
                        ...
                        <tr>
                            ...
                            <td><input type="date" id="from1" name="from1" required></td>
                            <td><input type="date" id="to1" name="to1" required></td>
                        ...
                        <tr>
                            ...
                            <td><input type="date" id="from2" name="from2"></td>
                            <td><input type="date" id="to2" name="to2"></td>
                            <td><input type="text" id="org_name2" name="org_name2"></td>
                        </tr>
                        <tr>
                            <td><label>3.</label></td>
                            <td><input type="text" id="job_desg3" name="job_desg3"></td>
                            <td><input type="date" id="from3" name="from3"></td>
                            <td><input type="date" id="to3" name="to3"></td>
                            <td><input type="text" id="org_name3" name="org_name3"></td>    </tr>
                        <tr>
                            <td><label>4.</label></td>    
                            <td><input type="text" id="job_desg4" name="job_desg4"></td>
                            <td><input type="date" id="from4" name="from4"></td>
                            <td><input type="date" id="to4" name="to4"></td>
                            <td><input type="text" id="org_name4" name="org_name4"></td>   
                        </tr>
                        <tr>
                            <td><label>5.</label></td>
                            <td><input type="text" id="job_desg5" name="job_desg5"></td>
                            <td><input type="date" id="from5" name="from5"></td>
                            <td><input type="date" id="to5" name="to5"></td>
                    ...
                    <fieldset>
                        ...
                        <label class="choice"> <input type="radio" name="membership" required value="BMA">B.M.A.</label>
                        ...
                        <label class="choice"> <input type="radio" name="membership" required value="others">Others</label>
                    </fieldset>
